...
<nav class="navbar navbar-default navbar-inverse" role="navigation">
    ...
    <c:when test="${Admin == 'Admin'}">
     ...
     <c:forEach var="item" items="${carList}">                        
        ...
        <div class="my-list">
            ...
            <h3 style="color:white">PickUp-##-##-####  DropOff-##-##-####</h3>
            <span style="color:white">${item.carName}</span>
            <span class="pull-right" style="color:white"><fmt:formatNumber type = "number" maxFractionDigits = "2"  value = "${item.rent_Price}" />$</span>
            ...
            <div class="detail">
                ...
                <img src="${item.carPhotos}" alt="dsadas" />
    ...
    <c:when test="${Customer == 'Customer'}">
     <c:forEach var="item" items="${carList}">                        
        ...
        <div class="my-list">
            <img style="color:white" src="${item.carPhotos}" alt="Car Image" />
            <h3 style="color:white">PickUp-${startDate}  DropOff-${endDate}</h3>
            <span style="color:white">${item.carName}</span>
            <span class="pull-right" style="color:white"><fmt:formatNumber type = "number" maxFractionDigits = "2"  value = "${item.rent_Price * noOfDays}" />$</span>
            <div class="offer" style="color:white">Car Capacity - ${item.car_Capacity} and Mileage - ${item.car_Milage}</div>
            <div class="detail">
                <p>VEHICLE TYPE - ${item.car_Type}</p>
                <img src="${item.carPhotos}" alt="dsadas" />
